...
// It should return the text 'ERROR' when the second number is 0.
  ...
  if (result == 0) throw new Error('Expected quotient(2, 0) to be any number execpt for 0. Received: ' + result);

// --------------------------------------------------
// Test Case 3
// --------------------------------------------------
// It should ignore additional numbers.
  var result = quotient(2, 1, 2, 2, 2, 2, 2);
  if (result !== 2) throw new Error('Expected quotient(2, 1, 2, 2, 2, 2, 2) to be 2. Received: ' + result);
